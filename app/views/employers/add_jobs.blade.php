    ...
    <div id="pad-wrapper">
        <div class="row">
                ...
                <div id="fuelux-wizard" class="wizard row">
                    <ul class="wizard-steps">
                        <li data-target="#step1" class="active"><span class="step">1</span>
                                <a href="Default.aspx"><span class="title">General
                                <br />
                            information</span>
                                    </a></li>
                        ...
                        <li data-target="#step4"><span class="step">4</span>
                                <a href="Employment.aspx"><span class="title">Employment</span>
                        </a>
                        </li>
                        <li data-target="#step5"><span class="step">5</span>
                                <a href="Others.aspx"><span class="title">Others</span>
                                    </a></li>
                        <li data-target="#step6"><span class="step">6</span>
                                <a href="FileUpload.aspx"><span class="title">Photograph /
                                <br />
            ...
            <div class="wizard-actions text-center">
                ...
                <a class="btn-glow primary btn-next pull-right" href="Contact.aspx">Next <i class="icon-chevron-right"></i></a>
            </div>
        </div>
    </div>
