...
<div id="content">
  <div id="title">
    <h1 class="inner job_page title-2">{{ $job->job_title }} <span id="jobs-counter">{{ $job->job_location }}</span>
          ...
          <div id="job-content-field">
            <div class="field-container single no_border">
              <div class="header-fields">
                ...
                <div class="date">{{ $job->created_at }}<span>Jun</span></div>
                <div class="title-company">
                  <div class="title"><a href="#">{{ $job->job_title }}</a></div>
                  <div class="company">{{ $job->job_location }}</div>
                </div>
              </div>
              ...
              <ul class="candidate-meta meta-fields">
                ...
                <div class="block skills">
                  ...
                  <div class="block-content">
                    <ul class="skill_list">
                      {{Testing::chk($job->job_responsibility) }}
                    </ul>
                  </div>
                </div>
              </div>
