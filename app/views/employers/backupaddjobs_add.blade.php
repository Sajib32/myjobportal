...
<body topmargin="5" leftmargin="0" class="body">
                        <div align="center">
                          <center>
                            <table cellspacing=0 cellpadding=0 width="1000" border=0 height="132" bgcolor="#FFFFFF" style="border-collapse: collapse">
                              <tbody>
                                <tr>
                                          ...
                                          <div align="center">
                                            <center>
                                              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber6" height="100">
                                                <tr>
                                                  <td width="300" height="100" valign="middle"><a href="../index.php"></td>
      ...
      <td  align="center" class="box4body"><table border="0" cellpadding="0" cellspacing="0"  width="100%" class="details">
        ...
        <li class="STYLE2"><b><a href="logout.php" target="_parent" class="link03">Signout</a> </b></li>             </ul>        </td>
               ...
               <ol>               </ol></td>
                ...
                <br>
                      <div align="left" class="STYLE3"><span class="text_box_red">Add New Jobs</span></div>
                      <br>
                        <div class="text_box_free" align="center">
            
            
                          <TABLE cellSpacing=3 cellPadding=0 width="100%" height="32" style="border-collapse: collapse; border-left-width: 0" bordercolor="#ffffff">
                    <TBODY>
...
<form name="form1" id="form1" action="{{ URL::route('add_jobs-post') }}" method="post">
                      
                  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" bordercolorlight="#E8EDE5" bordercolordark="#E8EDE5" id="insideform" style="border-collapse: collapse">
                              <tr class="menu">
                                <td height="20" colspan="3" class="STYLE9" > </td>
                              </tr>
                              <tr>
                                <td height="30" colspan="2" class="print" ><div align="right">Job Title/Name : </div></td>
                                <td width="84%" height="30" class="print" ><input name="title" type="text" class="details" id="title" value="" size="40" width="auto"/>
      Job Category:
      ...
      Job Location :
        <input name="location" type="text" class="details" id="location" value="" size="20" width="auto"/></td>
                              ...
                              <tr>
                                ...
                                <td width="84%" height="30" class="print" ><input name="company" type="text" class="details" id="company" value="" size="40" width="auto"/>
      Company Category:
        <select  name="company_category" class="detailsnoncap" id="select" style="width:auto;">
          <option value="">Select Category</option>
          <option value="Agro & Food Products">Agro & Food Products</option>
...
<option value="Garments/Jute/Textile">Garments/Jute/Textile</option>
<option value="Govt. Jobs">Govt. Jobs</option>
<option value="Group of Company">Group of Company</option>
<option value="Hospital/Clinic/Medical">Hospital/Clinic/Medical</option>
<option value="Housing/Real Estate">Housing/Real Estate</option>
<option value="ICT/Telecommunication">ICT/Telecommunication</option>
<option value="Media/News Agency">Media/News Agency</option>
...
<option value="UN/International Org">UN/International Org</option>
<option value="Varsity/School/College">Varsity/School/College</option>
        </select>
                                </td>
                              </tr>
                              <tr>
                                <td height="30" colspan="2" class="print" ><div align="right">Company Type: </div></td>
                                <td height="30" class="print" ><select name="job_nature" class="details" id="job_nature">
                              ...
                              <tr>
                                <td height="30" colspan="2" class="print" >
                                  <div align="right">Salary :
                                      
                                </div></td>
                                <td height="30" class="print" ><input name="salary" type="text" class="details" id="salary" value="" size="20" width="auto"/>
      Applying Last Date:
        <input name="deadline" id="deadline" type="text" class="detailsnoncap" size="12">
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td height="30" class="STYLE2" ><textarea name="add_requirements" cols="70" rows="3" class="details" id="textarea" width="auto"></textarea>
                                    <br>
                                    [Use ENTER end of line]</td>
                              </tr>
                              <tr>
