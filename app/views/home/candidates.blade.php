...
@foreach($jobseeker as $seeker)
          <div class="jobs-item with-thumb">
            <div class="clearfix visible-xs"></div>
            <h6 class="title"><a href="{{URL::route('view', $seeker->id)}}">{{ $seeker->fullname }}</h6>
            <span class="meta"></span><br >
            <span class="meta">Deadline: </span>
            <p class="description"><a href="{{ URL::route('jobseeker-profile', array($seeker->id)) }}">Read Details</a></p>
