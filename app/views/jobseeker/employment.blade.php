...
<body>
    ...
    <table class="display table table-hover table-bordered table-striped" cellspacing="0" align="Right" id="MainBodyContent_EmploymentGridView" style="border-collapse:collapse;">
        <tr>
            ...
            <th scope="col">Area of Experience</th>
        ...
        <tr>
            <td>
                {{ $e->company_name }} <br/> <strong>Business:</strong> Advertising Agency
                
                <br/> <strong>Location:</strong> {{ $e->company_name }}
            </td>
            <td>{{ $e->company_name }}</td>
            <td>{{ $e->company_name }}</td>
            <td>&nbsp;</td>
            <td>
                <strong>Category: </strong>Marketing/Sales <br/> <strong>Experience:</strong> Accounts, 
            </td>
            <td>
                Apr 02, 2015
            </td>
            ...
            <td>
                <a id="MainBodyContent_EmploymentGridView_employmentEditLink_0" href="javascript:__doPostBack(&#39;ctl00$MainBodyContent$EmploymentGridView$ctl02$employmentEditLink&#39;,&#39;&#39;)"><i class="icon-edit icon-2x"></i></a>
                <a onclick="Confirm();" id="MainBodyContent_EmploymentGridView_employmentLink_0" href="javascript:__doPostBack(&#39;ctl00$MainBodyContent$EmploymentGridView$ctl02$employmentLink&#39;,&#39;&#39;)"><i class="icon-remove icon-2x"></i></a>
            </td>
        </tr>
        @endforeach
    </table>
...
@endif
                                ...
                                <div class="modal-body">
                                    <div class="row form-wrapper">
                                        <div class="col-md-12">
                                            ...
                                            <div class="field-box">
                                                <label>Company Business:<span style="color: #ff0000;"> *</span></label>
                                                <div class="ui-select">
                                                    <select name="ctl00$MainBodyContent$CompanyBusinessText" id="MainBodyContent_CompanyBusinessText" class="CompanyBusinessText">
    ...
    <option value="81">Others</option>
                                            ...
                                            <div class="field-box companyOthersDiv" style="display: none">
                                                <label>Please Mention:<span style="color: #ff0000;"> *</span></label>
                                                <input name="ctl00$MainBodyContent$companyOthers" id="MainBodyContent_companyOthers" class="form-control companyOthers" type="text" />
                                            </div>
                                            <div class="field-box">
                                            ...
                                            <h4>Area of Experience(s)</h4>
                                            <hr />
                                            <div class="field-box">
                                                <label>Experience Category:</label>
                                                <div class="ui-select">
                                                    <select name="ctl00$MainBodyContent$expCategory" id="MainBodyContent_expCategory" class="expCategory" size="1">
    <option selected="selected" value="1">Accounting/Finance</option>
    ...
    <option value="18">Secretary/Receptionist</option>
                                            ...
                                            <div class="field-box">
                                                <label>Choose Experience(s):</label>
                                                <select name="ctl00$MainBodyContent$chooseEmpText" id="MainBodyContent_chooseEmpText" style="width: 250px" onselect="" multiple="multiple" class="select2 chooseEmpText">
    <option value=""></option>
    <option value="955">ACA/ACMA</option>
    <option value="961">Accounts</option>
    ...
    <option value="1100">Others</option>
    ...
    <option value="817">Zoology</option>
                ...
                <div class="wizard-actions text-center">
                    <a style="margin-left: 15px;" href="Academic.aspx" class="btn-glow primary btn-prev pull-left"><i class="icon-chevron-left"></i>Prev</a>
                    
                    <a class="btn-glow primary btn-next pull-right" href="Others.aspx" data-last="Finish">Next <i class="icon-chevron-right"></i></a>
                </div>
            </div>
        </div>
    </div>
